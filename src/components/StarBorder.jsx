...
const StarBorder = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute w-[300%] h-1/2 opacity-70 -bottom-3 -right-[250%] rounded-full z-0"
        style={{
      ...
      <div
        className="absolute w-[300%] h-1/2 opacity-70 -top-3 -left-[250%] rounded-full z-0"
        style={{
          background: `radial-gradient(circle, ${color}, transparent 10%)`,
